...
class NfcGameMapper {
    ...
    fun toGameTemplateResponse(
        ...
        globalWinnerPoints = template.globalWinnerPoints,
        globalSecondPlacePoints = template.globalSecondPlacePoints,
        globalThirdPlacePoints = template.globalThirdPlacePoints,
